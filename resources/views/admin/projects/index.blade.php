<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.projects.create') }}" class="bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-2 px-6 rounded-lg shadow-lg hover:shadow-indigo-500/30 transition-all text-sm uppercase tracking-wider">
                + Add New Project
            </a>
        </div>
    </x-slot>
                                ...
                                @foreach($projects as $project)
                                    <tr class="hover:bg-slate-800/50 transition-colors">
                                        ...
                                        <td class="px-5 py-5 border-b border-slate-800 bg-transparent text-sm text-right">
                                            <a href="{{ route('admin.projects.edit', $project->id) }}" class="text-indigo-400 hover:text-indigo-300 font-bold mr-4">Edit</a>
