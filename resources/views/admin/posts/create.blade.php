                    ...
                    <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="title" id="title" class="bg-slate-900 border border-slate-700 rounded-lg w-full py-3 px-4 text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition-colors" required>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="cover_image" class="block text-slate-300 text-sm font-bold mb-2 uppercase tracking-wide">Cover Image</label>
                            ...
                            <!-- Excerpt -->
                            <div>
                                <label for="excerpt" class="block text-slate-300 text-sm font-bold mb-2 uppercase tracking-wide">Excerpt (Short description)</label>
                                <textarea name="excerpt" id="excerpt" rows="3" class="bg-slate-900 border border-slate-700 rounded-lg w-full py-3 px-4 text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition-colors"></textarea>
                            </div>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="is_published" id="is_published" class="rounded border-slate-700 bg-slate-900 text-indigo-600 shadow-sm focus:ring-indigo-500 h-5 w-5">
                                <label for="is_published" class="ml-2 text-sm text-white font-bold">Publish Immediately?</label>
                            </div>
