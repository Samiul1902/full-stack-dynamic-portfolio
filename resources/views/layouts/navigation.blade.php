<nav x-data="{ open: false }" class="bg-slate-900/80 backdrop-blur-md border-b border-indigo-500/20 fixed w-full z-50">
        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="font-bold text-2xl text-white tracking-widest uppercase">
                        SAMIUL<span class="text-indigo-500">.</span>ADMIN
                    </a>
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-slate-800 focus:outline-none focus:bg-slate-800 focus:text-gray-500 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-slate-900 border-t border-slate-800">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-white hover:bg-indigo-500/20">
                {{ __('Dashboard') }}
