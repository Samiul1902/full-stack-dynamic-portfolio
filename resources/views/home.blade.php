            ...
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="https://bd.linkedin.com/in/samiul-hasan-sakib-b12237276" target="_blank" class="w-10 h-10 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center text-slate-400 hover:bg-[#0077b5] hover:text-white hover:border-[#0077b5] transition-all transform hover:-translate-y-1">
